...
// Module
___CSS_LOADER_EXPORT___.push([module.i, "/* You can add global styles to this file, and also import other style files */\nbody {\n  background: url('windows-xp-bliss.jpg');\n  background-size: cover;\n  background-repeat: no-repeat;\n}", "",{"version":3,"sources":["webpack://src/styles.scss"],"names":[],"mappings":"AAAA,8EAAA;AACA;EACI,uCAAA;EACA,sBAAA;EACA,4BAAA;AACJ","sourcesContent":["/* You can add global styles to this file, and also import other style files */\nbody {\n    background: url('./assets/windows-xp-bliss.jpg');\n    background-size: cover;\n    background-repeat:no-repeat;\n}"],"sourceRoot":""}]);
// Exports
